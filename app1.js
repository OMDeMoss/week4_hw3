/* Write a message to the console that says "Hello world!" */
...
/* 12) Write a blank line to the console. 
(I showed one way to do this in class, there are 
some others feel free to use those instead if you'd like, practice your google-fu) */

/* 13) Define and assign a variable named var2, the value should be of the number type */

/* 14) Evaluate var1 + var2 and write the result to the console 
(You can store the result in a variable and write it to the console, or 
    pass the expression into a method that will remain un-named)*/
